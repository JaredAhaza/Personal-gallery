...
class LocationTestClass(TestCase):
    def setUp(self):
        self.test_location = Location(location="kenya")
    ...
    def test_updating_image(self):
        self.test_location = Location(location="kenya")
        self.test_location.save_locations()
        updated = Location.update_location(1, 'kenya')
        self.assertTrue(updated, 'kenya')
...
class ImageTestClass(TestCase):
    def setUp(self):
        ...
        # Image
        self.test_image = Image(image="testImage",image_name="Test",description="This is a test",location=self.test_location)
    ...
    def test_deleting_image(self):
        self.test_image = Image(location="kenya")
        self.test_image.save_image()
...
class CategoryTestClass(TestCase):
    ...
    def test_updating_category(self):
        self.test = Category(location="cars")
        self.test.save_category()
        updated = Category.update_category(1, 'videogames')
        self.assertTrue(updated, 'videogames')